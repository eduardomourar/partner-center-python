...
class MicrosoftPartnerSdkContractsV1CollectionsPagedResourceCollectionMicrosoftPartnerSdkContractsV1UsageManagementCustomerMonthlyUsageRecord(Model):
    ...
    :vartype items:
     list[~azure.partnercenterservices.models.MicrosoftPartnerSdkContractsV1UsageManagementCustomerMonthlyUsageRecord]
    ...
    _attribute_map = {
        ...
        'items': {'key': 'items', 'type': '[MicrosoftPartnerSdkContractsV1UsageManagementCustomerMonthlyUsageRecord]'},
