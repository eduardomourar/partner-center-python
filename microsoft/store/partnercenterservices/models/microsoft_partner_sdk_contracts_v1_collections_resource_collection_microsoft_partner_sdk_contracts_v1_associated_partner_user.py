...
class MicrosoftPartnerSdkContractsV1CollectionsResourceCollectionMicrosoftPartnerSdkContractsV1AssociatedPartnerUser(Model):
    ...
    :vartype items:
     list[~azure.partnercenterservices.models.MicrosoftPartnerSdkContractsV1AssociatedPartnerUser]
    ...
    _attribute_map = {
        ...
        'items': {'key': 'items', 'type': '[MicrosoftPartnerSdkContractsV1AssociatedPartnerUser]'},
