...
class MicrosoftPartnerSdkContractsV1CollectionsResourceCollectionMicrosoftPartnerSdkContractsV1ContractsRoleManagementRole(Model):
    ...
    :vartype items:
     list[~azure.partnercenterservices.models.MicrosoftPartnerSdkContractsV1ContractsRoleManagementRole]
    ...
    _attribute_map = {
        ...
        'items': {'key': 'items', 'type': '[MicrosoftPartnerSdkContractsV1ContractsRoleManagementRole]'},
