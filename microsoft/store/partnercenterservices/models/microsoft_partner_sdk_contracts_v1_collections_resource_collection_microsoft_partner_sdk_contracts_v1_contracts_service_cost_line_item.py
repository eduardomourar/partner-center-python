...
class MicrosoftPartnerSdkContractsV1CollectionsResourceCollectionMicrosoftPartnerSdkContractsV1ContractsServiceCostLineItem(Model):
    ...
    :vartype items:
     list[~azure.partnercenterservices.models.MicrosoftPartnerSdkContractsV1ContractsServiceCostLineItem]
    ...
    _attribute_map = {
        ...
        'items': {'key': 'items', 'type': '[MicrosoftPartnerSdkContractsV1ContractsServiceCostLineItem]'},
