...
class MicrosoftPartnerSdkContractsV1CollectionsResourceCollectionMicrosoftPartnerSdkContractsV1SubscriptionAddOnReferral(Model):
    ...
    :vartype items:
     list[~azure.partnercenterservices.models.MicrosoftPartnerSdkContractsV1SubscriptionAddOnReferral]
    ...
    _attribute_map = {
        ...
        'items': {'key': 'items', 'type': '[MicrosoftPartnerSdkContractsV1SubscriptionAddOnReferral]'},
