...
class DeletevversionrolesroleOperations(object):
    ...
    def value(
            self, version, role_id=None, member_id=None, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
    ...
    def id(
            self, role_id, member_id, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        """Removes a user member of given member id from role with a given role id
        and id token passed in the header.
        Defaults to removing from applicable account.
