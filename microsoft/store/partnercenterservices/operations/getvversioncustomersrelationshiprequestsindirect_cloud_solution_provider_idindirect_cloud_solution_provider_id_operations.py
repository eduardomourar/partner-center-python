...
class GetvversioncustomersrelationshiprequestsindirectCloudSolutionProviderIdindirectCloudSolutionProviderIdOperations(object):
    ...
    def value(
            self, version, indirect_cloud_solution_provider_id=None, indirect_reseller_id=None, dual_role_indirect_relationship=None, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        """
