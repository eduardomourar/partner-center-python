...
class GetvversionratecardsazurecurrencycurrencyOperations(object):
    ...
    def value(
            self, version, currency=None, region=None, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        ...
        :rtype:
         ~azure.partnercenterservices.models.MicrosoftPartnerSdkContractsV1ContractsRateCardsAzureRateCard
