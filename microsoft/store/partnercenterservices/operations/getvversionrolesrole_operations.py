...
class GetvversionrolesroleOperations(object):
    ...
    def value(
            self, version, role_id=None, size=None, sort_field=None, sort_direction=None, seek_operation=None, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        ...
        :rtype:
         ~azure.partnercenterservices.models.MicrosoftPartnerSdkContractsV1CollectionsResourceCollectionMicrosoftPartnerSdkContractsV1ContractsRoleManagementRole
    ...
    def value1(
            self, version, role_id, size=None, sort_field=None, sort_direction=None, seek_operation=None, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        """Gets all the roles available.
