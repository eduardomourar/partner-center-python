...
class PostvversionservicerequestsagentOperations(object):
    ...
    def locale(
            self, agent_locale, service_request, version, ms_correlation_id=None, ms_request_id=None, custom_headers=None, raw=False, **operation_config):
        ...
        path_format_arguments = {
            'agent_locale': self._serialize.url("agent_locale", agent_locale, 'str'),
